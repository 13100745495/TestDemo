		      ...
		      <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal"  action="user/sign" method="post">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name" placeholder="姓名 / Name" required="required" name="username">
                                ...
                                <br/>
                                 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="password" id="user-phone" placeholder="输入你的密码/ Password" required="required" name="password" >
                                    </div>
                                </div>
                                <br/>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="email" id="user-email" placeholder="输入你的电子邮件 / Email" required="required" name="useremail">
                                    </div>
                                </div>
                                 <br/>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="tel" id="user-phone" placeholder="输入你的电话号码 / Telephone" required="required" name="userphone">
                                    </div>
                                </div>                           
                                  <br/>                        
                                <div class="am-form-group">
