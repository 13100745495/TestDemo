                        ...
                        <div class="tpl-form-body tpl-form-line">
                              <form class="am-form tpl-form-line-form"  >
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">景点名称 </label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input"   id="a_name" name="a_name" placeholder="请输入标题文字"/>
                                    </div>
                                </div>

                               <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">景点标题 </label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="a_title"   id="a_title"placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">添加备注 </label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">景点详情</label>
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" id="att_info" name="a_info"placeholder="请输入文章内容"></textarea>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <input type="button" onclick="attadd()" value="上传">
                                    </div>
                                </div>
                         </form>
                        </div>
