                        ...
                        <div class="tpl-form-body tpl-form-line">
                              <form class="am-form tpl-form-line-form"  >
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input"   id="h_name" name="h_name" placeholder="请输入标题文字"/>
                                    </div>
                                </div>

                               <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">联系 </label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="h_address" placeholder="请添加分类用点号隔开">
                                        <div>
                                        </div>
                                    </div>
                                </div>                             
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" id="h_info" name="a_info"placeholder="请输入文章内容"></textarea>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <input type="button" onclick="atthotel();" value="上传">
                                    </div>
                                </div>
                         </form>
                        </div>
